...
document.addEventListener('DOMContentLoaded', function() {
    ...
    GJAPI.iGameID    = localStorage.getItem('gameID');       // # change this
    GJAPI.sGameKey   = localStorage.getItem('gameKey');      // # change this too
    GJAPI.bAutoLogin = true;    // automatically log in users on Game Jolt
    GJAPI.bDebugMode = false;   // enable verbose console logging

    if(GJAPI.iGameID === 0 || GJAPI.sGameKey === "") console.log("Game ID or Game Key missing!");
    ...
    GJAPI.sUserName  = GJAPI.bLoggedIn ? GJAPI.asQueryParam["gjapi_username"] : localStorage.getItem('UserName');
    GJAPI.sUserToken = GJAPI.bLoggedIn ? GJAPI.asQueryParam["gjapi_token"]    : localStorage.getItem('UserToken');
